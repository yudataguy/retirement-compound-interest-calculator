...
fun UnderstandStep(state: AppState) {
    ...
    Column(
        ...
        Text("You added")
        Text(MoneyFormatter.format(result.totalContributed, state.currencySymbol))
        Text("Your money earned")
        Text(MoneyFormatter.format(result.totalInterest, state.currencySymbol))
